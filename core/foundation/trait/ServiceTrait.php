 ...
 */
namespace core\foundation\trait;
 ...
 * @method array|Model|null get($id, ?array $field = null, ?array $with = [], string $order = '', ?array $withoutScopes = null)获取一条数据
 ...
 * @method Model|null selectList(array $where, string $field = '*', int $page = 0, int $limit = 0, string $order = '', array $with = [], bool $search = false, ?array $withoutScopes = null) 获取列表
