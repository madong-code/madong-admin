...
use app\adminapi\schema\request\ops\gateway\RateRestrictionsFormRequest;
use app\adminapi\schema\request\ops\gateway\RateRestrictionsQueryRequest;
use app\adminapi\schema\response\ops\gateway\RateRestrictionsResponse;
use app\adminapi\validate\ops\gateway\RateRestrictionsValidate;
...
final class RateRestrictionsController extends Crud
{
    ...
    #[OA\Put(
        path: '/ops/rate-restrictions/{id}/status',
        summary: '切换状态',
        tags: ['限访名单'],
        x: [
            SchemaConstants::X_PROPERTY_IN => 'id',
