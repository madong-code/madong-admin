...
class RoleDao extends BaseDao
{
     ...
     * @param int|string  $id
     *
     * @return \app\model\system\role\Role|null
     * @throws \Exception
     */
    public function getImplicitPermissionsForRole(int|string $id): ?Role
    {
